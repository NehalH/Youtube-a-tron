...
if __name__ == "__main__":
    makeCompilation(path = "../downloads",
                    introName = "",
                    outroName = '',
                    totalVidLength = 10*60,
                    maxClipLength = 200,
...
# Locate the 'resize.py' file in the 'moviepy' library. 
# It should be in the path similar to 'venv\Lib\site-packages\moviepy\video\fx'.

# Open 'resize.py' in a text editor.
